function saveContent(){if(document.forms[0].htmlSource.value==""){tinyMCEPopup.close();
return false
}tinyMCEPopup.execCommand("mcePasteText",false,{html:document.forms[0].htmlSource.value,linebreaks:document.forms[0].linebreaks.checked});
tinyMCEPopup.close()
